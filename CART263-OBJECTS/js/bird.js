...
class Bird extends Animal {
    ...
    constructor(x, y, width, height) {
        ...
        //added a variable to have a y that is specific to the bird that is apart from the animal
    ...
    move() {
        ...
        this.angle += 0.05;
        /**
         * It is important to call the parent move because this class extends to the parent
         */
        super.move();
        this.veer();
        // this.x += this.vx;
